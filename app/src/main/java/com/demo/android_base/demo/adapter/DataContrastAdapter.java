    ...
    protected void convert(BaseViewHolder helper, MultiItemEntity item) {
        switch (helper.getItemViewType()) {
            case ITEM_0:
                ...
                rv.setAdapter(new BaseQuickAdapter<String, BaseViewHolder>(R.layout.item_data_contrast_lv0_block,list) {
                    @Override
                ...
                break;
            case ITEM_1:
                final DataContrastItem0 lv1 = (DataContrastItem0) item;
                ...
                break;
            case ITEM_2:
                final DataContrastItem0 lv2 = (DataContrastItem0) item;
                ...
                rv2.setAdapter(new BaseQuickAdapter(R.layout.item_data_contrast_lv2_block) {
                    @Override
